...
- Use case ini berkontribusi terhadap konsistensi antara snapshot inventory dan movement history.

Namun:

- Use case ini tidak melakukan rekonsiliasi
- Validasi dilakukan oleh Inventory Consistency Checker

Prinsip:

- Snapshot selalu diikuti movement
- Movement selalu mencerminkan perubahan snapshot
