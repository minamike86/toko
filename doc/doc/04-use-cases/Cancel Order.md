...
Use case ini berlaku untuk **sales order ke pelanggan / konsumen**.
Use case ini **bukan** cancel purchase order ke supplier.
Pembatalan purchase order berada pada domain Procurement dan didokumentasikan terpisah.
