...
## Quantity Standardization (Step 6.5)

Inventory hanya bekerja dengan canonical quantity.

Aturan:

- Semua mutation harus menggunakan canonical unit
- Inventory tidak menyimpan atau mengetahui conversion rule
- Inventory tidak melakukan conversion

Jika input bukan canonical:

→ wajib dinormalisasi sebelum mutation

Invariant tetap:

- stok tidak boleh negatif
- movement tetap immutable
- quantity tetap positif
